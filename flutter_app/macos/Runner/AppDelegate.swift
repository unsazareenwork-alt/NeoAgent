...
class AppDelegate: FlutterAppDelegate {
  private let desktopChannelName = "neoagent/desktop_companion_native"
  ...
  override func applicationDidFinishLaunching(_ notification: Notification) {
    ...
    channel.setMethodCallHandler { [weak self] call, result in
      self?.handleDesktopMethodCall(call, result: result)
    }
  }
  ...
  private func handleDesktopMethodCall(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    switch call.method {
    case "getStatus":
    ...
    case "click":
      ...
      guard let arguments = call.arguments as? [String: Any],
        ...
        result(FlutterError(code: "invalid_arguments", message: "Missing click coordinates.", details: nil))
        return
      }
    ...
    case "drag":
      ...
      guard let arguments = call.arguments as? [String: Any],
        ...
        result(FlutterError(code: "invalid_arguments", message: "Missing drag coordinates.", details: nil))
        return
      }
    ...
    case "scroll":
      ...
      guard let arguments = call.arguments as? [String: Any] else {
        result(FlutterError(code: "invalid_arguments", message: "Missing scroll payload.", details: nil))
        return
      }
    ...
    case "typeText":
      ...
      guard let arguments = call.arguments as? [String: Any] else {
        result(FlutterError(code: "invalid_arguments", message: "Missing text payload.", details: nil))
        return
      }
    ...
    case "pressKey":
      ...
      guard let arguments = call.arguments as? [String: Any],
        ...
        result(FlutterError(code: "invalid_arguments", message: "Missing key payload.", details: nil))
        return
      }
      do {
        try pressKey(key)
  ...
  private func buildDesktopStatus() -> [String: Any] {
    let permissions: [String: String] = [
      ...
      "inputControl": isAccessibilityTrusted() ? "available" : "required",
      "accessibility": isAccessibilityTrusted() ? "available" : "required",
    ]
  ...
  private func defaultDisplayIdentifier() -> String {
    return String(resolveDisplayId(nil))
  }
  ...
  private func frontmostWindowTitle() -> String? {
    ...
    guard focusedStatus == .success, let windowElement = focusedWindow else {
      return nil
    }
  ...
  private func performDrag(x1: Double, y1: Double, x2: Double, y2: Double, durationMs: Int) {
    ...
    let steps = max(4, min(90, durationMs / 16))
    ...
    for step in 1...steps {
      ...
      usleep(useconds_t(max(1, (durationMs * 1000) / max(1, steps))))
    }
